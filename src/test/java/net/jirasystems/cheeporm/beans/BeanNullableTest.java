 ...
 * 
 */
public class BeanNullableTest {

	private static Connection connection;
	private static Orm<BeanNullable> orm;
	private static Class<BeanNullable> type = BeanNullable.class;
	private BeanNullable bean = newBean();
	private BeanNullable readBack = newBean();

	public BeanNullableTest() throws IllegalAccessException, InstantiationException {
		// Here to cover the newInstance exceptions.
	}

	private BeanNullable newBean() throws InstantiationException, IllegalAccessException {
	...
	/**
	 * @throws Exception
	 *             If the database teardown8 throws any error
	 */
	@AfterClass
	...
	public void setUp() throws Exception {
		...
		orm = Orm.<BeanNullable> newInstance(connection);
	}
	...
	public void testCreate() throws SQLException, InstantiationException, IllegalAccessException {
		...
		// Then
		Assert.assertEquals(nonNullableFieldValue, readBack.getNonNullableField());
	 ...
	 */
	@Test
	public void testCreateNull() throws SQLException, InstantiationException, IllegalAccessException {
	...
	public void testUpdate() throws SQLException, InstantiationException, IllegalAccessException {
		...
		// Then
		Assert.assertEquals(nonNullableFieldValue[1], readBack.getNonNullableField());
		Assert.assertNull(readBack.getNullableField());
		Beans.compareBeans(bean, readBack);
	}
	 ...
	 */
	@Test
	public void testUpdateNull() throws SQLException, InstantiationException, IllegalAccessException {

		// Given
		bean = newBean();
		String[] nonNullableFieldValue = new String[] {"nonNullableFieldValue", null};
		String[] nullableFieldValue = new String[] {"nullableFieldValue", null};
		bean.setNonNullableField(nonNullableFieldValue[0]);
		bean.setNullableField(nullableFieldValue[0]);
